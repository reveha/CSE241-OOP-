...
Tetris& Tetris:: operator+=(Tetromino &shape){
    /*
...
void Tetris:: rotate_added_shape(const Tetromino &shape){
...
void Tetris:: Animate(Tetromino &shape, int count_move, int count_rotate, string direction){
    /*
...
void Tetris:: clear_top(const Tetromino &shape){
    ...
    if(shape.getKey()=='I'){
        b.board[1][(b.length/2)-2]='.'; b.board[1][(b.length/2)-1]='.';
        b.board[1][(b.length/2)]='.'; b.board[1][(b.length/2)+1]='.';
    }
    else if(shape.getKey()=='O'){
        b.board[1][(b.length/2)-1]='.'; b.board[1][(b.length/2)]='.';
        b.board[2][(b.length/2)-1]='.'; b.board[2][(b.length/2)]='.';
    }
    else if(shape.getKey()=='T'){
        b.board[2][(b.length/2)]='.'; b.board[1][(b.length/2)]='.';
        b.board[1][(b.length/2)-1]='.'; b.board[1][(b.length/2)+1]='.';
    }
    else if(shape.getKey()=='J'){
        b.board[3][(b.length/2)-1]='.'; b.board[3][(b.length/2)]='.';
        b.board[2][(b.length/2)]='.'; b.board[1][(b.length/2)]='.';
    }
    else if(shape.getKey()=='L'){
        b.board[3][(b.length/2)]='.'; b.board[2][(b.length/2)]='.';
        b.board[1][(b.length/2)]='.'; b.board[3][(b.length/2)+1]='.';
    }
    else if(shape.getKey()=='S'){
        b.board[2][(b.length/2)-1]='.'; b.board[2][(b.length/2)]='.';
        b.board[1][(b.length/2)]='.'; b.board[1][(b.length/2)+1]='.';
        ...
        b.board[2][(b.length/2)]='.'; b.board[2][(b.length/2)+1]='.';
        b.board[1][(b.length/2)]='.'; b.board[1][(b.length/2)-1]='.';
    }
}
bool Tetris:: check_index(const Tetromino &shape, int count, string direction){
    ...
    if(direction=="L"){
        count*=-1;
            ...
            if(shape.getKey()=='I'){
                    for(auto i=b.height-1;i>0;i--){
                        if(b.board[i][(b.length/2)-2+count]=='.'&&b.board[i][(b.length/2)-1+count]=='.'&&
                        b.board[i][(b.length/2)+count]=='.'&&b.board[i][(b.length/2)+1+count]=='.'&&
                        (shape.getRotated()==0||shape.getRotated()==2)){
                            //The if for I tetromino which is not rotated;
                            index_y=(b.length/2)-2+count;
                            index_x=i;
                            return true;
                            
                    }
                    else if(b.board[i][(b.length/2)+count]=='.'&&b.board[i-1][(b.length/2)+count]=='.'&&
                    b.board[i-2][(b.length/2)+count]=='.'&&b.board[i-3][(b.length/2)+count]=='.'&&
                    (shape.getRotated()==1||shape.getRotated()==3)){
                        //The if for I tetromino which is rotated;
                        index_y=(b.length/2)+count;
                        index_x=i;
                        return true;
                    }
                }
            ...
            for(auto i=b.height-1;i>0;i--){
                if(b.board[i][(b.length/2)-1+count]=='.'&&b.board[i][(b.length/2)+count]=='.'&&
                b.board[i-1][(b.length/2)-1+count]=='.'&&b.board[i-1][(b.length/2)+count]=='.'){
                    //The if for O tetromino
                    index_y=(b.length/2)-1+count;
                    index_x=i;
                    return true;
                }
            }
            ...
            for(auto i=b.height-1;i>0;i--){
                if(b.board[i][(b.length/2)+count]=='.'&&b.board[i-1][(b.length/2)+count]=='.'&&
                b.board[i-1][(b.length/2)-1+count]=='.'&&b.board[i-1][(b.length/2)+1+count]=='.'&&
                shape.getRotated()==0){
                ...
                b.board[i-1][(b.length/2)-1+count]=='.'&&b.board[i-2][(b.length/2)+count]=='.'&&
                shape.getRotated()==1){
                ...
                else if(b.board[i][(b.length/2)-1+count]=='.'&&b.board[i][(b.length/2)+count]=='.'&&
                b.board[i][(b.length/2)+1+count]=='.'&&b.board[i-1][(b.length/2)+count]=='.'&&
                shape.getRotated()==2){
            ...
            for(auto i=b.height-1;i>0;i--){
                if(b.board[i][(b.length/2)-1+count]=='.'&&b.board[i][(b.length/2)+count]=='.'&&
                b.board[i-1][(b.length/2)+count]=='.'&&b.board[i-2][(b.length/2)+count]=='.'&&
                shape.getRotated()==0){
                ...
                b.board[i][(b.length/2)+1+count]=='.'&&b.board[i-1][(b.length/2)-1+count]=='.'&&
                shape.getRotated()==1){
                ...
                else if(b.board[i][(b.length/2)-1+count]=='.'&&b.board[i-1][(b.length/2)-1+count]=='.'&&
                b.board[i-2][(b.length/2)-1+count]=='.'&&b.board[i-2][(b.length/2)+count]=='.'&&
                shape.getRotated()==2){
                ...
                b.board[i-1][(b.length/2)+count]=='.'&&b.board[i-1][(b.length/2)-1+count]=='.'&&
                shape.getRotated()==3){
            ...
            for(auto i=b.height-1;i>0;i--){
                if(b.board[i][(b.length/2)+count]=='.'&&b.board[i-1][(b.length/2)+count]=='.'&&
                b.board[i-2][(b.length/2)+count]=='.'&&b.board[i][(b.length/2)+1+count]=='.'&&
                shape.getRotated()==0){
                ...
                b.board[i-2][(b.length/2)+count]=='.'&&b.board[i-2][(b.length/2)-1+count]=='.'&&
                shape.getRotated()==2){
            ...
            for(auto i=b.height-1;i>0;i--){
                ...
                b.board[i-1][(b.length/2)-1+count]=='.'&&b.board[i-2][(b.length/2)-1+count]=='.'&&
                (shape.getRotated()==1||shape.getRotated()==3)){
            ...
            for(auto i=b.height-1;i>0;i--){
                if(b.board[i][(b.length/2)+count]=='.'&&b.board[i][(b.length/2)+1+count]=='.'&&
                b.board[i-1][(b.length/2)+count]=='.'&&b.board[i-1][(b.length/2)-1+count]=='.'&&
                (shape.getRotated()==0||shape.getRotated()==2)){
...
void Tetris::create_board(){
	...
	b.board=new char*[b.height];
    for(auto i=0;i<b.height;i++)
        b.board[i]=new char[b.length];
...
void Tetris:: clear(){
    ...
    for(auto i=b.height-2;i>0;i--){
        for(auto j=1;j<b.length-1;j++){
            if(b.board[i][j]!='.'){counter++;}
        }
        if(counter==b.length-2){
            for(auto k=i-1;k>0;k--){
                for(auto t=1;t<b.length-1;t++){
                    b.board[k+1][t]=b.board[k][t];
                }
            }
            for(auto t=1;t<b.length-1;t++){
                b.board[1][t]='.';
...
void Tetris:: fill_just_y_indexes(const Tetromino &shape){
...
void Tetris:: fill_indexes(const Tetromino &shape){
    ...
    if(shape.getKey()=='I'){
        if(shape.getRotated()==0){
            ...
            b.board[index_x][index_y+2]='I';
            b.board[index_x][index_y+3]='I';
        }
        else if(shape.getRotated()==1){
            b.board[index_x][index_y]='I';
